...
iRaceDeck provides **31 actions** with **317 controls** across 8 categories. See the [Actions Overview](/docs/actions/overview/) for a full breakdown, or jump to a category:
